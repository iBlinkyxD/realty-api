...
class Listing(Base):
    ...
    is_deal             = Column(Boolean, nullable=False, server_default="false")
    deal_discount_value = Column(Numeric(12, 2))
    deal_discount_type  = Column(Text, nullable=False, server_default="pct")
